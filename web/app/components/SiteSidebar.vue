...
<template>
  ...
  >
    ...
    >
      ...
      <!--
        `lg:mt-auto` anchors the socials and the copyright to the bottom of the sticky column.
        On a phone the panel is content-height inside a scrolling sheet, so they simply follow
        the nav.
      ...
      -->
      <ul class="mt-12 flex items-center gap-5 lg:mt-auto lg:pt-12">
      ...
      <p class="type-caption mt-6 text-muted lg:pb-10">
        {{ SITE.copyright }}
      </p>
    </div>
  </aside>
