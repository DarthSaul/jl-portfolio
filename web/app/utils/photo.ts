 ...
 *
 * Auto-imported from `~/utils`, like `formatDate`, and shared for the same reason: three call
 * sites needed the identical fallback and the identical arithmetic. `GalleryGrid` divides by it
